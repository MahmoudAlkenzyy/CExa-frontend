...
const CustomerInfo = () => {
  ...
  return (
    ...
    >
      <h2 className="font-semibold text-sm md:text-base 2xl:text-xl flex items-center gap-1 md:flex-wrap">
      ...
      <ul className="text-white">
        <li className="flex items-center gap-2 pb-3">
          <div className="">
            <Image
              ...
              alt="Profile"
              className="2xl:w-16 2xl:h-16 w-12 h-12 rounded-full"
            />
          </div>
          <div className="">
        ...
        <li className="flex flex-col md:flex-row items-center  gap-2 text-xs md:text-sm  py-2">
